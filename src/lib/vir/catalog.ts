...
export const VIR_IMPLEMENTATION_PHASES = [
  {
    phase: "Phase 1",
    title: "Foundation",
    outcome: "Inspection catalogue, vessel master, questionnaire template engine, structured import validation, and core management review.",
  },
  {
    phase: "Phase 2",
    title: "Operational Workflow",
    outcome: "Inspection creation, questionnaire completion, observations, corrective actions, carryover, and sign-off workflow.",
  },
  {
    phase: "Phase 3",
    title: "AI Import Engine",
    outcome: "PDF upload, extraction orchestration, confidence review, audit trail, and commit-to-draft import flow.",
  },
  {
    phase: "Phase 4",
    title: "Dashboard and Mobility",
    outcome: "Fleet dashboard, PDF export, offline tablet experience, and polished ship/shore collaboration.",
  },
];
