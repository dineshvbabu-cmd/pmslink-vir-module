      ...
      {activePane === "details" ? (
        <div className="vir-details-pane panel panel-elevated" style={{ padding: 0 }}>
          ...
          <div className="vir-report-section">
            ...
            {/* ── Sign-off trail (read-only; editable via workflow buttons) ── */}
            {inspection.signOffs.length > 0 ? (
              <div className="vir-report-section" style={{ borderTop: "1px solid var(--color-border)", paddingTop: "1rem", marginTop: "0.5rem" }}>
                ...
                <div className="stack-list" style={{ marginTop: "0.5rem" }}>
                  {inspection.signOffs.map((signOff) => (
                    <div className="list-card" key={signOff.id}>
                      ...
                      <div className="list-card-title">{signOff.actorName ?? "—"}</div>
